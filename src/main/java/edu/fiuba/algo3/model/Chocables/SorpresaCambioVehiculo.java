...
public class SorpresaCambioVehiculo implements Chocable {
    ...
    public IEfecto devolverEfecto(Moto moto) {
        Logger.getInstance().log("El jugador iba con una moto y se choco con una sorpresa de cambio de vehiculo");
        return new CambioDeVehiculo(new Auto());
    }

    @Override
    public IEfecto devolverEfecto(Auto auto) {
        Logger.getInstance().log("El jugador iba con un auto y se choco con una sorpresa de cambio de vehiculo");
        return new CambioDeVehiculo(new Todoterreno());
    }

    @Override
    public IEfecto devolverEfecto(Todoterreno todoterreno) {
        Logger.getInstance().log("El jugador iba con una 4x4 y se choco con una sorpresa de cambio de vehiculo");
